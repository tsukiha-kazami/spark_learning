...
object DstreamJoinDstream {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val kafkaParams2= Map[String, Object](
      ...
      "auto.offset.reset" -> "latest",
      "enable.auto.commit" -> (true: java.lang.Boolean),
      "group.id" -> "join_stream_group2")


    //spark环境
    val sparkConf = new SparkConf().setAppName("DstreamJoinDstream").setMaster("local[6]")
